...
public class LeriButton : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (PlayerPrefs.GetString("Character") == "7")
            {
                onClickButton();
            }
        }
    ...
    public void onClickButton()
    {
        ...
        GameObject playerPrefab = Resources.Load<GameObject>("Models/Larry/Player");
        ...
        if (CharacterController.Instance.NameChar != null)
            CharacterController.Instance.NameCharRender.text = CharacterController.Instance.NameChar[6];
        SelectButton.character = "7";
    }
}
