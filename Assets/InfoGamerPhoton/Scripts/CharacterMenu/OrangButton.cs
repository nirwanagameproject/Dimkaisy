...
public class OrangButton : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (PlayerPrefs.GetString("Character") == "6")
            {
                onClickButton();
            }
        }
    ...
    public void onClickButton()
    {
        ...
        GameObject playerPrefab = Resources.Load<GameObject>("Models/Orang/Player");
        ...
        if (CharacterController.Instance.NameChar != null)
            CharacterController.Instance.NameCharRender.text = CharacterController.Instance.NameChar[5];
        SelectButton.character = "6";
