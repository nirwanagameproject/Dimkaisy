...
public class SpongebobButton : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (PlayerPrefs.GetString("Character") == "2")
            {
                onClickButton();
            }
        }
    ...
    public void onClickButton()
    {
        ...
        GameObject playerPrefab = Resources.Load<GameObject>("Models/Spongebob/Player");
        ...
        if (CharacterController.Instance.NameChar != null)
            CharacterController.Instance.NameCharRender.text = CharacterController.Instance.NameChar[1];
        SelectButton.character = "2";
    }
}
