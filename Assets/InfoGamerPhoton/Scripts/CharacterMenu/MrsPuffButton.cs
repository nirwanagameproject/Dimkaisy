...
public class MrsPuffButton : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (PlayerPrefs.GetString("Character") == "8")
            {
                onClickButton();
            }
        }
    ...
    public void onClickButton()
    {
        ...
        GameObject playerPrefab = Resources.Load<GameObject>("Models/Mrs Puff/Player");
        ...
        if (CharacterController.Instance.NameChar != null)
            CharacterController.Instance.NameCharRender.text = CharacterController.Instance.NameChar[7];
        SelectButton.character = "8";
    }
}
