...
public class PatrickButton : MonoBehaviour
{
    ...
    public void onClickButton()
    {
        ...
        GameObject playerPrefab = Resources.Load<GameObject>("Models/Patrick/Player");
        ...
        if (CharacterController.Instance.NameChar != null)
            CharacterController.Instance.NameCharRender.text = CharacterController.Instance.NameChar[0];
        SelectButton.character = "1";
    }
}
