...
public class SandyButton : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (PlayerPrefs.GetString("Character") == "4")
            {
                onClickButton();
            }
        }
    ...
    public void onClickButton()
    {
        ...
        GameObject playerPrefab = Resources.Load<GameObject>("Models/Sandy/Player");
        ...
        CharacterController.Instance.NameCharRender.text = CharacterController.Instance.NameChar[3];
        SelectButton.character = "4";
