...
public class CustomMatchmakingRoomController : MonoBehaviourPunCallbacks
{
    ...
    void ListPlayers() 
    {
        ...
        numberPlayer.text = "Player List ("+PhotonNetwork.CurrentRoom.PlayerCount+"/20)";
